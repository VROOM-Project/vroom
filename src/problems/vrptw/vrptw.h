...
private:
  static constexpr std::array<h_param, 32> homogeneous_parameters =
    {h_param(HEURISTIC_T::BASIC, INIT_T::EARLIEST_DEADLINE, 1.2),
     ...
     h_param(HEURISTIC_T::BASIC, INIT_T::NONE, 0.6),
     h_param(HEURISTIC_T::BASIC, INIT_T::NONE, 2.1),
     h_param(HEURISTIC_T::BASIC, INIT_T::EARLIEST_DEADLINE, 1.7),
     h_param(HEURISTIC_T::BASIC, INIT_T::FURTHEST, 0.6),
     ...
     h_param(HEURISTIC_T::BASIC, INIT_T::HIGHER_AMOUNT, 1.1),
     h_param(HEURISTIC_T::BASIC, INIT_T::HIGHER_AMOUNT, 1.7),
     ...
     h_param(HEURISTIC_T::BASIC, INIT_T::FURTHEST, 1.5),

     h_param(HEURISTIC_T::BASIC, INIT_T::NONE, 0.8),
     h_param(HEURISTIC_T::BASIC, INIT_T::HIGHER_AMOUNT, 0.6),
     h_param(HEURISTIC_T::BASIC, INIT_T::EARLIEST_DEADLINE, 0.4),
     h_param(HEURISTIC_T::BASIC, INIT_T::EARLIEST_DEADLINE, 2.2),

     h_param(HEURISTIC_T::BASIC, INIT_T::FURTHEST, 0.1),
     h_param(HEURISTIC_T::BASIC, INIT_T::FURTHEST, 0.2),
     h_param(HEURISTIC_T::BASIC, INIT_T::FURTHEST, 0.8),
     h_param(HEURISTIC_T::BASIC, INIT_T::FURTHEST, 1.4)};
