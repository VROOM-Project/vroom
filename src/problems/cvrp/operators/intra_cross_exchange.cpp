...
CVRPIntraCrossExchange::CVRPIntraCrossExchange(
  const Input& input,
...
bool CVRPIntraCrossExchange::is_valid() {
  return true;
}

void CVRPIntraCrossExchange::apply() {
...
std::vector<Index> CVRPIntraCrossExchange::addition_candidates() const {
  return {};
}
